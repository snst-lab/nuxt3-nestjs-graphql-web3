...
@ArgsType()
export class FindFirstProjectLedgerOrThrowArgs {
    ...
    @Field(() => [Project_ledgerScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Project_ledgerScalarFieldEnum>;
}
