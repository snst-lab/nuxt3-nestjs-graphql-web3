...
import { ContributorWhereInput } from '../contributor/contributor-where.input';
import { Type } from 'class-transformer';
import { ContributorOrderByWithRelationInput } from '../contributor/contributor-order-by-with-relation.input';
import { ContributorWhereUniqueInput } from '../contributor/contributor-where-unique.input';
import { Int } from '@nestjs/graphql';
import { ContributorScalarFieldEnum } from '../contributor/contributor-scalar-field.enum';

@ArgsType()
export class FindFirstContributorOrThrowArgs {
