...
## UseCase0_投票トークンの送付先のホワイトリストを登録する

> **ユーザーロール:  事務局**

今回、ERC20 という汎用的なトークン規格を用いてるため、そのままだとトークンが外部のDefiやDex へ流出する可能性があります。送金先のホワイトリストを Smart Contract に登録することで、流通範囲を制限します。


https://user-images.githubusercontent.com/40202502/227505091-07244270-3a75-4843-af77-48bb7c9c2061.mp4
...
> **事務局ユーザーへのアピールポイント**
> 
> EVMアドレス入力フォーム上、不正なチェックサムを持つ EVM アドレスを入力送信しようとした場合、コントラクト送信前にフロントエンドでもチェックをかけて弾いています。（万一フロントバリデーションを除外して送られた場合でも、メタマスク上でのエラーになるのみ）
